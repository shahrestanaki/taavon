...
$.jgrid.regional["fa"] = {
        ...
        search: {
            ...
            Find: "جستجو",
            Reset: "حذف فیلتر",
            odata: [{ oper:'eq', text:"برابر"},{ oper:'ne', text:"نا برابر"},{ oper:'lt', text:"به"},{ oper:'le', text:"کوچکتر"},{ oper:'gt', text:"از"},{ oper:'ge', text:"بزرگتر"},{ oper:'bw', text:"شروع با"},{ oper:'bn', text:"شروع نشود با"},{ oper:'in', text:"نباشد"},{ oper:'ni', text:"عضو این نباشد"},{ oper:'ew', text:"اتمام با"},{ oper:'en', text:"تمام نشود با"},{ oper:'cn', text:"حاوی"},{ oper:'nc', text:"نباشد حاوی"},{ oper:'nu', text:'خالی باشد'},{ oper:'nn', text:'خالی نباشد'}, {oper:'bt', text:'بین'}],
            groupOps: [{
                op: "AND",
                text: "کل"
            },
        ...
        edit: {
            ...
            bExit: "انصراف",
            msg: {
                required: "فیلدها حتما باید پر شوند",
        ...
        nav: {
			...
			savetext: "",
			savetitle: "ذخیره رکورد",
			canceltext: "",
			canceltitle : "انصراف ویرایش رکورد",
        ...
        formatter: {
            ...
            date: {
                dayNames: ["يک", "دو", "سه", "چهار", "پنج", "جمع", "شنبه", "يکشنبه", "دوشنبه", "سه شنبه", "چهارشنبه", "پنجشنبه", "جمعه", "شنبه"],
