...
;(function($) {
	...
	$.confirm = function(options) {
		...
		var settigns = $.extend({
			...
			dialogFooter = '<div class="modal-footer">' + (settigns.buttonOk ? buttonOk : '') + '&nbsp' + (settigns.buttonCancel ? buttonCancel : '') + '</div>',
			$dialog = $('<div id='+ settigns.id +'  class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">' +/*****MSH****/
				'<div class="modal-dialog modal-sm" role="document">' +
				'<div class="modal-content" style="width:'+settigns.width+'">' +
